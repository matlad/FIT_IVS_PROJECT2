\hypertarget{_lex_exception_8h}{}\section{Lex\+Exception.\+h File Reference}
\label{_lex_exception_8h}\index{Lex\+Exception.\+h@{Lex\+Exception.\+h}}
...
\begin{center}
\leavevmode
\includegraphics[width=164pt]{_lex_exception_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=164pt]{_lex_exception_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
